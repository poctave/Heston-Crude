...
The results are based on a single static snapshot. A rolling SVJ Hessian analysis
(analogous to the full-sample Hessian in Chapter~\ref{ch:hessian}) would be needed
to assess whether the SVJ identifiability properties are stable across regimes or
whether SVJ provides gains only in specific market conditions.
